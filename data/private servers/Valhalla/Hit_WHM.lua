...
function init_gear_sets()
    ...
    sets.midcast.CureSolace = {main="Chatoyant Staff", head="Healer's cap", body="Seer's Tunic", hands="Zealot's Mitts", legs="Healer's Pantaloons", feet="Seer's Pumps +1",
    neck="Promise Badge", waist="Friar's Rope", left_ear="Valor Earring", right_ear="Valor Earring", left_ring="Solace Ring", right_ring="Solace Ring", back="White Cape +1"}

    sets.midcast.Cure = {main="Chatoyant Staff", head="Healer's cap", body="Seer's Tunic", hands="Zealot's Mitts", legs="Healer's Pantaloons", feet="Seer's Pumps +1",
    neck="Promise Badge", waist="Friar's Rope", left_ear="Valor Earring", right_ear="Valor Earring", left_ring="Solace Ring", right_ring="Solace Ring", back="White Cape +1"}
	...
	sets.midcast['Elemental Magic'] = {main="Aquilo's Staff", head="Sage's Circlet", waist="Shaman's Belt", hands="Tarutaru mitts", ring1="Zircon Ring", ring2="Zircon Ring", neck="Black Neckerchief" }
    ...
    -- Resting sets
    sets.resting = {main="Spiro Staff", body="Seer's tunic", waist="Qiqirn Sash +1", neck="Beak Necklace"}

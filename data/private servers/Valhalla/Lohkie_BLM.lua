...
function get_sets()
	...
	sets.midcast.EleMagic =     {
		main={ name="Laevateinn", augments={'"Fast Cast"+2','INT+4','System: 1 ID: 131 Val: 5',}},
		sub={ name="Elementa Grip", augments={'System: 1 ID: 131 Val: 5','"Fast Cast"+4','"Treasure Hunter"+1',}},
		ammo={ name="Phtm. Tathlum", augments={'"Fast Cast"+2','INT+4','System: 1 ID: 131 Val: 5',}},
		head={ name="Goetia Petasos +2", augments={'System: 1 ID: 131 Val: 5','"Fast Cast"+4','INT+6','"Treasure Hunter"+1',}},
		body={ name="Goetia Coat +2", augments={'System: 1 ID: 131 Val: 5','"Fast Cast"+4','INT+6','"Treasure Hunter"+1',}},
		hands={ name="Goetia Gloves +2", augments={'System: 1 ID: 131 Val: 5','"Fast Cast"+4','INT+6','"Treasure Hunter"+1',}},
		legs={ name="Goet. Chausses +2", augments={'"Fast Cast"+2','System: 1 ID: 131 Val: 5','INT+6','"Treasure Hunter"+1',}},
		feet={ name="Goetia Sabots +2", augments={'System: 1 ID: 131 Val: 5','"Fast Cast"+4','INT+6','"Treasure Hunter"+1',}},
		neck={ name="Feud Pendant", augments={'System: 1 ID: 131 Val: 5','INT+6','Fire Affinity: Avatar perp. cost+3','"Treasure Hunter"+1',}},
		waist={ name="Sanctuary Obi", augments={'System: 1 ID: 131 Val: 5','INT+6','Fire Affinity: Avatar perp. cost+3','"Treasure Hunter"+1',}},
		left_ear={ name="Hecate's Earring", augments={'System: 1 ID: 131 Val: 5','INT+6','Fire Affinity: Avatar perp. cost+3','"Treasure Hunter"+1',}},
		right_ear={ name="Moldavite Earring", augments={'"Fast Cast"+2','System: 1 ID: 131 Val: 1','INT+4',}},
		left_ring={ name="Icesoul Ring", augments={'System: 1 ID: 131 Val: 5','INT+6','Fire Affinity: Avatar perp. cost+3','"Treasure Hunter"+1',}},
		right_ring={ name="Icesoul Ring", augments={'System: 1 ID: 131 Val: 5','"Fast Cast"+4','INT+6','Fire Affinity: Avatar perp. cost+3',}},
		back={ name="Goetia Mantle", augments={'"Fast Cast"+2','System: 1 ID: 131 Val: 5','INT+6','"Treasure Hunter"+1',}},
	}
...
function midcast(spell)  
	...
	--if spell.english == "Blizzard III" then
		--send_command('wait '..t3delay..';input /ma "Aero III" '..target)
	--elseif spell.english == "Aero III" then	
--		send_command('wait '..t3delay..';input /ma "Stone III'..target)
--	elseif spell.english == "Stone III" then
		--send_command('wait '..t3delay..';input /ma "Thunder III'..target)
	--end	
	
	--if spell.english == "Blizzard II" then
--		send_command('wait '..t2delay..';input /ma "Aero II'..target)
--	elseif spell.english == "Aero II" then	
		--send_command('wait '..t2delay..';input /ma "Stone II'..target)
	--end
...
function self_command(command)
	if command:lower() == "t3nukes" then
		...
		send_command('input /ma "Blizzard III'..target)
	elseif command:lower() == "t2nukes" then
		add_to_chat(8,"T2's? Y'sure? Alrighty then!")
		send_command('input /ma "Blizzard II'..target)	

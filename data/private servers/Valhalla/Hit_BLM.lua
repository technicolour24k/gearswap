...
function get_sets()
	...
	sets.midcast.EleMagic =     {
		...
		--legs={ name="Teal Slops +1", augments={'System: 1 ID: 131 Val: 1','INT+4','Occ. inc. resist. to stat. ailments +10',}},
		legs={ name="Teal Slops +1"},
    ...
    sets.midcast.Myrkr = {    }
    sets.midcast.Cure = {main="Iridal Staff", body="Wizard's Coat", hands="Serpentes Cuffs", feet="Serpentes Sabots",
	...
	send_command('input /echo [Alt+F12] Bound to Nuke-Bot toggle;bind !F12 gs c nuker')
...
function precast(spell)
	...
	send_command('send Zoku /ma ' ..spell.english.. ' ' ..spell.target.id)
	send_command('send Lohkie /ma ' ..spell.english.. ' ' ..spell.target.id)
...
--			mule_in_party = "yes"
	...
	--if mule_in_party == "yes" then
		--if not spell.english == "Warp" then
	--		send_command('input /t Zoku '..spell.english..'')
		--end
--	end

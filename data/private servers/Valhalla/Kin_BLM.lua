...
function precast(spell)
	...
	setTargetID(player.target.id)
	
	send_command('send Zoku /ma '..spell.english.. ' ' ..target)
	send_command('send Hit /ma '..spell.english.. ' ' ..target)
	send_command('send Lohkie /ma '..spell.english.. ' ' ..target)

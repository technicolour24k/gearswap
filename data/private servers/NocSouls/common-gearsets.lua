function init_gear_sets(job)
	...
	--RDM
	RDM_AF_HEAD = "Atrophy Chapeau +1"
	RDM_AF_BODY = "Atrophy Tabard +1"
	RDM_AF_HANDS = "Atrophy Gloves +1"
	RDM_AF_LEGS = "Atrophy Tights +1"
	RDM_AF_FEET = "Atrophy Boots +1"
	...
	--THF
	THF_AF_HEAD = "Pillager's Bonnet +1"
	THF_AF_BODY = "Pillager's Vest +1"
	THF_AF_HANDS = "Pillager's Armlets +1"
	THF_AF_LEGS = "Pillager's Culottes +1"
	THF_AF_FEET = "Pillager's Poulaines +1"
	...
	--PLD
	PLD_AF_HEAD = "Reverence Coronet +1"
	PLD_AF_BODY = "Reverence Surcoat +1"
	PLD_AF_HANDS = "Reverence Gauntlets +1"
	PLD_AF_LEGS = "Reverence Breeches+1"
	PLD_AF_FEET = "Reverence Leggings +1"
	...
	--SAM
	SAM_AF_HEAD = "Wakido Kabuto +1"
	SAM_AF_BODY = "Wakido Domaru +1"
	SAM_AF_HANDS = "Wakido Kote +1"
	SAM_AF_LEGS = "Wakido Haidate +1"
	SAM_AF_FEET = "Wakido Sune-Ate +1"
	...
	--SMN
	SMN_AF_HEAD = "Convoker's Horn +1"
	SMN_AF_BODY = "Convoker's Doublet +1"
	SMN_AF_HANDS = "Convoker's Bracers +1"
	SMN_AF_LEGS = "Convoker's Spats +1"
	SMN_AF_FEET = "Convoker's Pigaches +1"
